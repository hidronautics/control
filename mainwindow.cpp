    ...
    ui(new Ui::MainWindow)
{
    ...
    QPixmap pix_back("D:/Gidronavtika/iceberg-control/images/background.png");
    ui->label_pic->setScaledContents(true);
    ui->label_pic->setPixmap(pix_back);

    //Motors
    QPixmap pix_mot("D:/Gidronavtika/iceberg-control/images/Motors.png");
    ...
    if (5==5)
    {
        QPixmap pix_green("D:/Gidronavtika/iceberg-control/images/LEDgreen");
    ...
    {
       QPixmap pix_red("D:/Gidronavtika/iceberg-control/images/LEDred");
       ui->label_indicator1->setScaledContents(true);
    ...
    //Indicator bluetooth
    QPixmap pix_bt("D:/Gidronavtika/iceberg-control/images/BT.png");
    ui->label->setScaledContents(true);
    ui->label->setPixmap(pix_bt);

    if (5==5) //No bluetooth signal
    {
        QPixmap pix_redB("D:/Gidronavtika/iceberg-control/images/LED2");
        ui->label_indicator2->setScaledContents(true);
        ui->label_indicator2->setPixmap(pix_redB);
    }
    else
    {
       QPixmap pix_greenB("D:/Gidronavtika/iceberg-control/images/LED3");
       ui->label_indicator2->setScaledContents(true);
